# 运动控制 (Motion Control) — Level 2: ROS2 / C++ / Mixed Bridge

English: [README.en.md](./README.en.md)

## 定位

本目录是运动控制方向的 **工程桥接层**。它的目标不是用 C++ 重写 Level 1 的 Python 代码，而是把 Level 1 建立的算法直觉接入 ROS2 / C++ / 真实机器人软件栈。
...
运动控制方向的 Level 2 候选桥接主题包括：

- **PID 控制桥接**：将 PID 控制器的 Python 实现接入 ROS2 实时控制循环
- **轨迹优化桥接**：将轨迹优化算法接入 `trajectory_msgs` 标准消息
- **实时控制**：利用 C++ 的实时性优势，实现低延迟的控制回路
- **硬件接口**：接入真实电机或关节控制器的驱动接口
...
- [运动控制 Level 1](../level-1-python/README.md)
