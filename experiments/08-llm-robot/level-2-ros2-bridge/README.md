# 大模型与机器人 (LLM and Robotics) — Level 2: ROS2 / C++ / Mixed Bridge

English: [README.en.md](./README.en.md)

## 定位

本目录是大模型与机器人方向的 **工程桥接层**。它的目标不是用 C++ 重写 Level 1 的 Python 代码，而是把 Level 1 建立的算法直觉接入 ROS2 / C++ / 真实机器人软件栈。
...
大模型与机器人方向的 Level 2 候选桥接主题包括：

- **任务规划桥接**：将 LLM 任务分解算法接入 ROS2 行为树或状态机
- **工具调用桥接**：将工具调用接口映射到 ROS2 服务/动作
- **执行监控**：接入 ROS2 的执行监控和错误恢复机制
- **多模态接口**：支持视觉-语言-动作的多模态输入输出
...
- [大模型与机器人 Level 1](../level-1-python/README.md)
