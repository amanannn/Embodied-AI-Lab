# World Models — Level 2: ROS2 / C++ / Mixed Bridge

中文： [README.md](./README.md)

## Positioning

This directory is the **engineering bridge layer** for the world models direction. Its goal is not to rewrite Level 1 Python code in C++, but to connect the algorithmic intuition built in Level 1 into ROS2 / C++ / real robot software stacks.
...
Candidate bridge themes for the world models direction include:

- **Prediction model bridge**: Connect dynamics prediction models into ROS2 planning nodes
- **Rollout bridge**: Connect Python rollout pipelines into C++ real-time inference
- **Planning coupling**: Couple prediction models with ROS2 planners
- **Model serving**: Wrap trained models as ROS2 services
...
- [World Models Level 1](../level-1-python/README.en.md)
